...
TEST_CASE(
    ...
    "[mson][property_member]") {
    mdp::ByteBuffer source = "- color: red (string) - A color\n\n"
                             "    Which is also very nice\n\n"
                             "    - and awesome\n\n"
                             "    - Default: yellow\n"
                             "    - Sample\n\n"
...
TEST_CASE("Parse mson property member object with nested members",
    ...
    REQUIRE(propertyMember.node.sections[0]
                .content.elements()
                .at(0)
                .content.property.name.literal == "first_name");
    REQUIRE(propertyMember.node.sections[0]
                .content.elements()
                .at(0)
    ...
    REQUIRE(propertyMember.node.sections[0]
                .content.elements()
                .at(0)
                .content.property.valueDefinition.values.size() == 1);
    REQUIRE(propertyMember.node.sections[0]
                .content.elements()
                .at(0)
    ...
    REQUIRE(propertyMember.node.sections[0]
                .content.elements()
                .at(0)
                .content.property.description == "A sample value");
    REQUIRE(propertyMember.node.sections[0].content.elements().at(1).klass ==
            mson::Element::PropertyClass);
    REQUIRE(propertyMember.node.sections[0]
                .content.elements()
                .at(1)
                .content.property.name.literal == "last_name");
    REQUIRE(propertyMember.node.sections[0]
                .content.elements()
                .at(1)
                .content.property.name.variable.empty());
...
TEST_CASE(
    ...
    "[mson][property_member]") {
    mdp::ByteBuffer source = "- user (array)\n\n"
                             "    List of users\n"
                             "    - Properties\n"
                             "        - first_name\n"
                             "        - last_name";
...
TEST_CASE(
    ...
    "[mson][property_member]") {
    mdp::ByteBuffer source = "- user (object)\n"
                             "    - username (string)\n"
                             "    - Properties\n"
                             "        - last_name\n"
                             "    - first_name (string)";
    ...
    REQUIRE(propertyMember.node.sections[0]
                .content.elements()
                .at(0)
                .content.property.name.literal == "username");
    REQUIRE(propertyMember.node.sections[1].klass ==
            mson::TypeSection::MemberTypeClass);
...
TEST_CASE("Parse mson property member when it is an object and has no sub-type "
          "specified and with member group",
    "[mson][property_member]") {
    mdp::ByteBuffer source = "- user\n\n"
                             "    This is good\n"
                             "    - Properties\n"
                             "        - last_name: sunkara (string)";
    ...
    REQUIRE(propertyMember.node.valueDefinition.typeDefinition.typeSpecification
                .name.base == mson::UndefinedTypeName);
    REQUIRE(propertyMember.node.valueDefinition.typeDefinition.typeSpecification
                .name.symbol.empty());
...
TEST_CASE("Parse mson property member when it is a string and has no sub-type "
          "specified",
    "[mson][property_member]") {
    mdp::ByteBuffer source = "- username\n\n"
...
TEST_CASE("Parse mson property member when no sub-type specified and no nested "
          "sections",
    "[mson][property_member]") {
    mdp::ByteBuffer source = "- username\n\n"
                             "    Some block description";
...
TEST_CASE("Parse mson property member when containing a mixin",
    "[mson][property_member]") {
    mdp::ByteBuffer source = "- formal_person (object)\n"
                             "  - prefix: Mr\n"
                             "  - Include Person";
    ...
    REQUIRE(
        propertyMember.node.sections[0]
            .content.elements()
            .at(1)
            .content.mixin.typeSpecification.name.symbol.literal == "Person");
...
TEST_CASE("Parse mson property member containing a list of values and no type "
          "specification",
    "[mson][property_member]") {
...
TEST_CASE("Parse mson property containing list of value with string type "
          "specification",
    "[mson][property_member]") {
