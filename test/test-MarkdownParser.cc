...
//    
//    ASTNode list1_itemB = list1.children()[0];
//    REQUIRE(list1_itemB.type == ListASTNodeType);
//    REQUIRE(list1_itemB.text.empty());
//    REQUIRE(list1_itemB.data == 0);
//    REQUIRE(list1_itemB.children().size() == 2);
//    REQUIRE(list1_itemB.sourceMap.size() == 1);
//    REQUIRE(list1_itemB.sourceMap[0].location == 0);
//    REQUIRE(list1_itemB.sourceMap[0].length == 36);
//
//}
