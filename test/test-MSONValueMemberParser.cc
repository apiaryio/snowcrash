...
TEST_CASE("Parse mson value member with block description, default and sample",
    "[mson][value_member]") {
    mdp::ByteBuffer source = "- red (string) - A color\n\n"
                             "    Which is also very nice\n\n"
                             "    - and awesome\n\n"
                             "    - Default: yellow\n"
                             "    - Sample\n\n"
...
TEST_CASE("Parse mson value member array with sample", "[mson][value_member]") {
    mdp::ByteBuffer source = "- (array) - List of colors\n\n"
...
TEST_CASE("Parse mson value member array with items", "[mson][value_member]") {
    ...
    REQUIRE(valueMember.node.sections[0]
                .content.elements()
                .at(0)
                .content.value.description == "A sample value");
