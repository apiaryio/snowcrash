...
TEST_CASE("Parse canonical mson named type", "[mson][named_type]") {
    ...
    REQUIRE(element.content.property.valueDefinition.typeDefinition
                .typeSpecification.name.base == mson::StringTypeName);
    ...
    REQUIRE(element.content.property.valueDefinition.typeDefinition.baseType ==
            mson::PrimitiveBaseType);
    REQUIRE(element.content.property.valueDefinition.typeDefinition
                .typeSpecification.name.base == mson::BooleanTypeName);
    REQUIRE(element.content.property.sections.empty());
    ...
    REQUIRE(element.content.property.valueDefinition.typeDefinition.baseType ==
            mson::ValueBaseType);
    REQUIRE(element.content.property.valueDefinition.typeDefinition
                .typeSpecification.name.base == mson::ArrayTypeName);
    REQUIRE(element.content.property.sections.empty());
    ...
    REQUIRE(element.content.property.valueDefinition.typeDefinition.baseType ==
            mson::ObjectBaseType);
    REQUIRE(element.content.property.valueDefinition.typeDefinition
                .typeSpecification.name.base == mson::ObjectTypeName);
    ...
    REQUIRE(subelement.content.property.valueDefinition.typeDefinition
                .typeSpecification.name.base == mson::NumberTypeName);
    ...
    REQUIRE(namedType.sourceMap.sections.collection[0]
                .elements()
                .collection.size() == 5);
    ...
    SourceMapHelper::check(
        ...
        175,
        34);
    REQUIRE(elementSM.property.sections.collection[1]
                .elements()
                .collection.size() == 2);
...
TEST_CASE("Parse type attributes on named type", "[mson][named_type]") {
    mdp::ByteBuffer source = "# User (fixed)\n"
                             "+ p1: a\n"
                             "+ p2: b\n";
