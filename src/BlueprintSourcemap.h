 ...
 */
template <> struct SourceMap<Parameter> : public SourceMapBase
{
 ...
 */
template <> struct SourceMap<MSONParameter> : public SourceMap<Parameter>
{};
 ...
 */
template <> struct SourceMap<DataStructure> : public SourceMap<mson::NamedType>
{};
 ...
 */
template <> struct SourceMap<Payload> : public SourceMapBase
{
 ...
 */
template <> struct SourceMap<TransactionExample> : public SourceMapBase
{
 ...
 */
template <> struct SourceMap<Action> : public SourceMapBase
{
 ...
 */
template <> struct SourceMap<Resource> : public SourceMapBase
{
 ...
 */
template <> struct SourceMap<Element> : public SourceMapBase
{
 ...
 */
template <> struct SourceMap<ResourceGroup> : public SourceMap<Element>
{};

/**
 * Source Map Structure for Group of Data Structures (Category Element)
 */
template <> struct SourceMap<DataStructureGroup> : public SourceMap<Element>
{};
 ...
 */
template <> struct SourceMap<Blueprint> : public SourceMap<Element>
{
