...
template <typename T> struct SourceMap : public SourceMapBase
{};
...
template <> struct SourceMap<mson::TypeSection> : public SourceMapBase
{
...
template <> struct SourceMap<mson::NamedType> : public SourceMapBase
{
...
template <> struct SourceMap<mson::ValueMember> : public SourceMapBase
{
...
template <> struct SourceMap<mson::Element> : public SourceMapBase
{
